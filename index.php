...
<div class="container" style="max-width: 1200px;">
	...
	<div class="row">
		...
		<div class="col-md-6">
			<p>This CLOUD CLASSROOMS includes:</p>
			<ul>
				<li>Student and faculty interactions</li>
				<li>Taking assessment and providing result</li>
				<li>Asking queries</li>
				<li>Watch videos uploaded by the faculty</li>
				<li>Updating the details of your profile</li>
