	...
	<div class="row">
		<div class="col-md-4">
			...
			if ( isset( $_POST[ 'addnewfaculty' ] ) ) {
				...
				$temppass = $_POST[ 'pass' ];
				// adding new faculty
				if(strlen($tempphno)<10 || strlen($tempphno)>10) {
					echo "<center><div class='alert alert-danger fade in __web-inspector-hide-shortcut__'' style='margin-top:10px;'><a href='#' class='close' data-dismiss='alert' aria-label='close' title='close'>&times;</a>
					<h3 style='margin-top: 10px; margin-bottom: 10px;'>Correct the phone format</h3></div></center>
					";
				}
				else {
